...
skybox = load_model("skybox.d3d");
tree = load_model("tree.d3d");
glass_block = load_model("glass_block.d3d");

object_positions = [];
repeat (25) {
    array_push(object_positions, { x: random(room_width), y: random(room_height) });
}
